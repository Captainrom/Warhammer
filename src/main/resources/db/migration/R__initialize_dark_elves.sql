...
INSERT INTO options (unit_id, name, points, pointsPerModel) VALUES
    ...
    ((SELECT unit_id from units WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves'), 'May be armed with one of the following:', null, null),
    ((SELECT unit_id from units WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves'), 'May be armed with one of the following:', null, null),
    ...
    ((SELECT unit_id from units WHERE unit_name ='Master' AND faction = 'Dark Elves'), 'May be armed with one of the following:', null, null),
    ((SELECT unit_id from units WHERE unit_name ='Master' AND faction = 'Dark Elves'), 'May be armed with one of the following:', null, null),
...
INSERT INTO options (unit_id, name, points, pointsPerModel, parent_option) VALUES
    ...
    ((SELECT unit_id from units WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves'), 'Additional hand weapon (unless mounted)', 3, true, (SELECT option_id FROM options LEFT JOIN units USING (unit_id) WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves' AND name ='May be armed with one of the following:')),
    ((SELECT unit_id from units WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves'), 'Halberd', 3, true, (SELECT option_id FROM options LEFT JOIN units USING (unit_id) WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves' AND name ='May be armed with one of the following:')),
    ((SELECT unit_id from units WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves'), 'Lance (mounted only)', 7, true, (SELECT option_id FROM options LEFT JOIN units USING (unit_id) WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves' AND name ='May be armed with one of the following:')),
    ((SELECT unit_id from units WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves'), 'Great weapon', 6, true, (SELECT option_id FROM options LEFT JOIN units USING (unit_id) WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves' AND name ='May be armed with one of the following:')),
    ((SELECT unit_id from units WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves'), 'Repeater crossbow', 5, true, (SELECT option_id FROM options LEFT JOIN units USING (unit_id) WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves' AND name ='May be armed with one of the following:')),
    ((SELECT unit_id from units WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves'), 'Repeater handbow', 5, true, (SELECT option_id FROM options LEFT JOIN units USING (unit_id) WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves' AND name ='May be armed with one of the following:')),
    ((SELECT unit_id from units WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves'), 'Brace of repeater handbows', 10, true, (SELECT option_id FROM options LEFT JOIN units USING (unit_id) WHERE unit_name ='Dreadlord' AND faction = 'Dark Elves' AND name ='May be armed with one of the following:')),
